...
<div id="landingPage">
  ...
  <nav class="nav">
    <a class="nav-brand" href="#">
      <div class="nav-brand-mark"><img src="images/castpro1.png" alt="FBCast Pro" style="width:100%;height:100%;object-fit:cover;border-radius:inherit;display:block;"></div>
    ...
    <div class="footer-grid">
      ...
      <div class="footer-brand-col">
        <a class="footer-brand" href="#">
          <div class="nav-brand-mark" style="width:34px;height:34px;font-size:14px;"><img src="images/castpro1.png" alt="FBCast Pro" style="width:100%;height:100%;object-fit:cover;border-radius:inherit;display:block;"></div>
...
<div id="appPage" style="display:none">
  ...
  <div class="topbar">
    <div class="topbar-brand">
      <div class="topbar-mark"><img src="images/castpro1.png" alt="FBCast Pro" style="width:100%;height:100%;object-fit:cover;border-radius:inherit;display:block;"></div>
