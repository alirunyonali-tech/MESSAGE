...
<div class="login-wrap">
  <div class="login-card">
    <div class="login-logo" style="background:none;box-shadow:none;"><img src="images/fbcast-pro.png" alt="FBCast Pro" style="width:60px;height:60px;object-fit:contain;border-radius:12px;display:block;margin:0 auto;"></div>
    <h1>FBCast Admin</h1>
...
<div class="layout">
  ...
  <div class="sidebar">
    <div class="sb-brand">
      <div class="sb-brand-icon" style="background:none;padding:0;overflow:hidden;"><img src="images/fbcast-pro.png" alt="FBCast Pro" style="width:36px;height:36px;object-fit:contain;border-radius:8px;display:block;"></div>
      <div>
